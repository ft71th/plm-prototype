    ...
    <div ref={containerRef} style={{
      ...
      <svg
        ...
        style={{
          ...
          cursor: isPanning ? 'grabbing' : activeTool === 'addMessage' && msgSource ? 'crosshair' : 'default',
        }}
        onWheel={handleWheel}
