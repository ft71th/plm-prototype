...
function ComponentLibraryPanel({ isOpen, onClose, nodes, onAddFromLibrary, libraryItems, onSaveToLibrary, onRefresh }: any) {
            ...
            >
              ...
              {selectedItem?.id === item.id && (
                <div style={{ marginTop: '10px', display: 'flex', gap: '8px' }}>
                  <button
                    onClick={(e: any) => { e.stopPropagation(); onAddFromLibrary && onAddFromLibrary(item); }}
