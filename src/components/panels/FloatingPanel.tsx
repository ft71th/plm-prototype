      ...
      <div style={{ 
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <input
              ...
              onChange={(e: any) => onUpdate(node.id, 'version', e.target.value)}
              disabled={!isEditable}
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input
            ...
            onChange={(e: any) => onUpdate(node.id, 'label', e.target.value)}
            disabled={!isEditable}
            onFocus={(e) => e.target.select()}
            style={{
              width: '100%',
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <select
            ...
            onChange={(e: any) => onUpdate(node.id, 'state', e.target.value)}
            style={{
              width: '100%',
              padding: '8px',
              background: 'var(--nl-bg-input, #34495e)',
        ...
        {node.data.itemType === 'requirement' && (
          <div style={{ marginBottom: '15px' }}>
            ...
            <select
              ...
              onChange={(e: any) => onUpdate(node.id, 'origin', e.target.value)}
              disabled={!isEditable}
              style={{
                width: '100%',
                padding: '10px',
        ...
        {node.data.itemType === 'requirement' && (
          <div style={{ marginBottom: '15px' }}>
            ...
            <select
              ...
              onChange={(e: any) => onUpdate(node.id, 'reqType', e.target.value)}
              disabled={!isEditable}
              style={{
                width: '100%',
                padding: '10px',
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <select
            ...
            onChange={(e: any) => onUpdate(node.id, 'classification', e.target.value)}
            disabled={!isEditable}
            style={{
              width: '100%',
              padding: '10px',
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <select
            ...
            onChange={(e: any) => onUpdate(node.id, 'priority', e.target.value)}
            disabled={!isEditable}
            style={{
              width: '100%',
              padding: '8px',
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input
            ...
            onChange={(e: any) => onUpdate(node.id, 'owner', e.target.value)}
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <textarea
            ...
            onChange={(e: any) => onUpdate(node.id, 'rationale', e.target.value)}
          ...
          <>
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'purpose', e.target.value)}
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'preconditions', e.target.value)}
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'testSteps', e.target.value)}
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'expectedResults', e.target.value)}
          ...
          <>
            <div style={{ marginBottom: '15px' }}>
              ...
              <select
                ...
                onChange={(e: any) => onUpdate(node.id, 'paramType', e.target.value)}
                disabled={!isEditable}
                style={{
                  width: '100%',
                  padding: '8px',
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '15px' }}>
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'paramValue', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'paramUnit', e.target.value)}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px', marginBottom: '15px' }}>
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'paramMin', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'paramMax', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'paramDefault', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
          ...
          <>
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <input
                ...
                onChange={(e: any) => onUpdate(node.id, 'hwIconSize', parseInt(e.target.value))}
                disabled={!isEditable}
                style={{
                  width: '100%',
                  cursor: 'pointer'
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <input
                ...
                onChange={(e: any) => onUpdate(node.id, 'manufacturer', e.target.value)}
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '15px' }}>
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'partNumber', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e: any) => onUpdate(node.id, 'serialNumber', e.target.value)}
                  disabled={!isEditable}
                  style={{
                    width: '100%',
                    padding: '8px',
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'specifications', e.target.value)}
          ...
          <>
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'mainFlow', e.target.value)}
                disabled={!isEditable}
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'alternativeFlows', e.target.value)}
                disabled={!isEditable}
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'postconditions', e.target.value)}
                disabled={!isEditable}
          ...
          <>
            <div style={{ marginBottom: '15px' }}>
              ...
              <select
                ...
                onChange={(e: any) => onUpdate(node.id, 'actorType', e.target.value)}
                disabled={!isEditable}
                style={{
                  width: '100%',
                  padding: '8px',
            ...
            <div style={{ marginBottom: '15px' }}>
              ...
              <textarea
                ...
                onChange={(e: any) => onUpdate(node.id, 'responsibilities', e.target.value)}
                disabled={!isEditable}
