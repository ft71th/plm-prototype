...
function RelationshipPanel({ edge, onClose, onUpdate, position }: any) {
  return (
    <div 
      ...
      <div style={{ marginBottom: '12px' }}>
        ...
        <select
          ...
          onChange={(e: any) => onUpdate(edge.id, 'relationType', e.target.value)}
          style={{
            width: '100%',
            padding: '10px',
            background: '#34495e',
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          onChange={(e: any) => onUpdate(edge.id, 'customLabel', e.target.value)}
      ...
      {(edge.data?.signalType || edge.data?.busWidth) && (
        ...
        <textarea
          ...
          onChange={(e: any) => onUpdate(edge.id, 'notes', e.target.value)}
          onClick={(e: any) => e.stopPropagation()}
