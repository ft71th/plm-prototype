import type { LabelDef, IssueType, IssueSeverity, IssueStatus } from '../types';

export const ISSUE_CATEGORIES: Record<IssueType, LabelDef> = {
...
export const ISSUE_PRIORITIES: Record<IssueSeverity, LabelDef> = {
...
export const ISSUE_STATUSES: Record<IssueStatus, LabelDef> = {
